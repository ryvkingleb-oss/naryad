...
export const patent: Procedure = {
  ...
  blank: {
    ...
    blankNote:
      "Страница МВД называет бланк и образец. Файл сервиса раскладывает ответы по тем же клеткам: фамилия, документ, миграционная карта, учёт, язык, работа, прежний патент. Фото 30×40 мм наклеиваете сами. Подпись — от руки. Служебные графы «документы принял» пустые.",
  },
  sources: [
    {
