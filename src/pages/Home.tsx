  ...
  return (
    <div className="home">
      <section className="hero">
        ...
        <p className="price">
          <strong>490 ₽</strong>
          <span>за один готовый файл. Списки, чек-листы и пустые бланки бесплатны. Касса сейчас тестовая: деньги не списываются. Это плата сервиса, не госпошлина. В подразделение файл несёте сами.</span>
        </p>
      </section>
